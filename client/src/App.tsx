...
const AdminStakingPairs = lazy(() => import('./pages/admin-staking-pairs'));
    ...
    <MainLayout>
      <Suspense fallback={<LoadingScreen />}>
        <Switch>
          ...
          <Route path="/admin/staking-pairs" component={isAuthenticated && isAdmin ? AdminStakingPairs : adminRedirect} />
          {/* User routes */}
