    ...
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            <DialogTitle className="text-foreground">Withdraw Requests</DialogTitle>
          </DialogHeader>
          <div className="flex items-center justify-center py-8">
            <div className="text-center text-muted-foreground">Loading withdraw requests...</div>
          </div>
        </DialogContent>
      </Dialog>
    );
    ...
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-4xl">
          ...
          <div className="flex items-center justify-center py-8">
            <div className="text-center text-danger">Error loading withdraw requests</div>
          </div>
        </DialogContent>
      </Dialog>
    );
                      ...
                      {request.status === 'pending' && (
                        <>
                          <Button
                            ...
                            className="text-success border-success/30 bg-success/10 hover:bg-success/20 text-xs"
                          >
                          ...
                          <Button
                            ...
                            className="text-danger border-danger/30 bg-danger/10 hover:bg-danger/20 text-xs"
                          >
        ...
        <Dialog open={showReviewModal} onOpenChange={() => setShowReviewModal(false)}>
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4">
              ...
              {action === 'approve' && (
                <div>
                  <Label htmlFor="screenshot">Upload Withdrawal Screenshot</Label>
                  <Input
                    id="screenshot"
                    type="file"
                    accept="image/*"
                  ...
                  {screenshotPreview && (
                    <div className="mt-2">
                      <img src={screenshotPreview} alt="Screenshot preview" className="max-w-full h-32 object-contain border border-border rounded" />
                      <Button variant="outline" size="sm" onClick={removeScreenshot} className="mt-1">
                        Remove
                      </Button>
                    </div>
                  )}
              ...
              {action === 'reject' && (
                <>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="requireReverification">
              ...
              <div className="flex space-x-2">
                <Button
                  ...
                  className={action === 'approve' ? 'bg-success hover:bg-success/90 text-success-foreground' : 'bg-destructive hover:bg-destructive/90 text-destructive-foreground'}
                >
