...
const ICON_OVERRIDES: Record<string, string> = {
  XAU:  'https://assets.coincap.io/assets/icons/xaut@2x.png', // Tether Gold icon for XAU spot gold
  XAUT: 'https://assets.coincap.io/assets/icons/xaut@2x.png', // Tether Gold token
...
const BRAND_COLORS: Record<string, string> = {
  ...
  UNI: '#ff007a', VET: '#15bdff', XAU: '#cfb53b', XAUT: '#cfb53b', XAG: '#c0c0c0',
};
