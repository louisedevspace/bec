...
import {
  ...
  Bell, Check, CheckCheck, ExternalLink, Coins, CircleDot, Headphones, Gift, Landmark
} from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Bank Deposits', href: '/admin/bank-deposits', icon: Landmark, description: 'Bank Transfer Deposits' },
