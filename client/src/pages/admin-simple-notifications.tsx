...
export default function AdminSimpleNotifications() {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., /trading, /wallet, /settings"
                disabled={sending}
              />
              <p className="text-xs text-muted-foreground">
                Users will be directed to this page when they click the notification
              </p>
            </div>
